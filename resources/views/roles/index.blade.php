...
@section('description', __('backend::roles.description'))
        ...
        @else
            <div class="text-center m-t-30 m-b-30 p-b-10">
                ...
                <p class="text-muted">
                    ...
                    <a href="{{ route('backend.roles.create') }}" class="text-custom">
                        <ins>@lang('backend::roles.create')</ins>
                    </a>
                </p>
            </div>
        @endif
